...
git clone https://github.com/wechulimaven/shop.git
...
pipeline {
    ...
    stages {
        stage('Checkout') {
            steps {
                git credentialsId: 'GIT_CREDENTIALS_ID', url: 'https://github.com/wechulimaven/shop.git'
            }
        }
...
2. Run on terminal in projects directory
``make run_local``