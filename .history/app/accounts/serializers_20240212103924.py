...
from utilities.choices import UserGoals, UserInterest, AUTH_PROVIDER
from utilities.tasks import (
    send_you_have_subscribed_email,
    send_you_have_unsubscribed_email,
)
...
class AdminTokenSerializer(TokenSerializer):
